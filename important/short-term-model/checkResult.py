...
from client import load_data, predict, RegressionLSTM
...
if __name__ == '__main__':
  ...
  trainloader, testloader, trainDataset, testDataset = load_data(file_name, "2022-04-10","2022-04-13", hyper_parameters["seq_len"],hyper_parameters["step_len"])
