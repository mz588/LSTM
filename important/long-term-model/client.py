...
hyper_parameters = {"num_features":5, "num_layers":1, "num_hidden_units":1, "batch_size":256, "epoch":50, "lr":3e-4, "seq_len":96, "step_len":96, "patience":50, "delta":0.001}
...
class RegressionLSTM(nn.Module):
    def __init__(self, num_features,num_layers, hidden_units, out_features):
        super().__init__()
        self.num_features = num_features  # this is the number of features
        self.hidden_units = hidden_units
        self.num_layers = num_layers # Defines the number of connected LSTM 
...
if __name__ == '__main__':
  ...
  net = RegressionLSTM(num_features=num_features, hidden_units=hidden_units, out_features=out_features, num_layers=hyper_parameters["num_layers"]).to(DEVICE)
  optimizer = torch.optim.Adam(net.parameters(), lr=learning_rate)
  trainloader, testloader, trainDataset, testDataset = load_data(file_name, "2022-04-01", "2022-04-30", hyper_parameters["seq_len"], hyper_parameters["step_len"])
